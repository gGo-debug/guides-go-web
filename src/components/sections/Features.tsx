        ...
        <div className="space-y-6 mb-24  flex flex-col items-center">
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-[1.15] max-w-4xl text-white text-center">
            ...
            <span className="relative inline-block">
              <span className="bg-gradient-to-r from-orange-500 via-amber-400 to-orange-500 text-transparent bg-clip-text">
                Choose Guides GO
              </span>
            ...
            >
              ...
              <div className="relative h-full p-8 flex flex-col justify-between z-10">
                ...
                <div className="transform translate-y-2 group-hover:translate-y-0 transition-transform duration-500 text-center">
                  ...
                  <div className="w-12 h-1 bg-orange-500 rounded-full transform origin-center scale-x-0 
                    group-hover:scale-x-100 transition-transform duration-500 mx-auto"></div>
                </div>
                
                {/* Description at bottom */}
                <div className="space-y-6">
                  <CardDescription className="text-white/80 group-hover:text-white/90 text-base leading-relaxed 
