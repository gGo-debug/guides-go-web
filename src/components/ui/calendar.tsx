  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(
          "h-9 w-9 p-0 font-normal aria-selected:opacity-100 hover:bg-slate-100 rounded-md hover:text-slate-900"
        ),
        day_range_end: "day-range-end",
        day_selected:
          "bg-[#0E9871] text-white hover:bg-[#0E9871] hover:text-white focus:bg-[#0E9871] focus:text-white",
        ...
        day_range_middle:
          "aria-selected:bg-slate-100 aria-selected:text-slate-900 dark:aria-selected:bg-slate-800 dark:aria-selected:text-slate-400",
